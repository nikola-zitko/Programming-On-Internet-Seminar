...
class Upisi(models.Model):
    student = models.ForeignKey('Korisnici', models.DO_NOTHING)
    predmet = models.ForeignKey('Predmeti', models.DO_NOTHING)
    status = models.CharField(max_length=64)

    def __str__(self):
        return (self.student.email+" "+self.predmet.ime+" ("+self.status+")")
    class Meta:
